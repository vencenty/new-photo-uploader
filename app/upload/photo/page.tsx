    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b sticky top-0 z-10">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-lg font-medium">照片冲印</h1>
          <button 
      ...
      <div className="flex-1 px-4 py-4 bg-gray-50">
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            ...
            className="aspect-[3/4] bg-white rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center hover:border-orange-500 transition-colors"
          >
          ...
          {photos.map((photo) => (
            <div key={photo.id} className="relative">
              <div className="aspect-[3/4] bg-white rounded-lg overflow-hidden shadow-sm relative group">
                {/* 删除按钮 */}
                <button
